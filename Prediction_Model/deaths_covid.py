...
from deaths_modeling import LSTM, Dataset, get_splits
...
class CovidProjection(LightningModule):
    ...
    def test_epoch_end(self, outputs):
        ...
        predictions.to_csv("deaths_predictions.csv", header=True, index=False)
        cases.to_csv("deaths.csv", header=True, index=False)
